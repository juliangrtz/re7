...
public partial class REFPlugin {
    ...
    private static readonly Dictionary<string, string[]> ChapterAmmoAvailability = new(StringComparer.Ordinal){
        ...
        ["C03_3_Main"] =
            ["HandgunBullet", "HandgunBulletL", "ShotgunBullet", "MagnumBullet", "AcidBulletS", "FlameBulletS"],
        ["C03_4_Main"] =[
            "HandgunBullet", "HandgunBulletL", "ShotgunBullet", "MagnumBullet", "AcidBulletS", "FlameBulletS",
            "BurnerBullet"
        ],
    ...
    private static readonly Dictionary<string, (int MinWeight, int MaxWeight)> DlcCoinWeights =
    ...
    private static readonly Dictionary<string, string> EnemyDropProbabilityConfigIdsByTypeId =
    ...
    private static readonly Dictionary<string, double> SpecialEnemyDropMultipliers =
        new(StringComparer.OrdinalIgnoreCase){
