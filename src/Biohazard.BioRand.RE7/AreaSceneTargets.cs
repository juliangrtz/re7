...
public sealed class AreaSceneTargets
{
    ...
    public IReadOnlyList<Guid> GetEnemyGeneratorGuids() => EnemyGeneratorGuids is null ? Array.Empty<Guid>() : EnemyGeneratorGuids;
    public IReadOnlyList<Guid> GetEnemySpawnInfoGuids() => EnemySpawnInfoGuids is null ? Array.Empty<Guid>() : EnemySpawnInfoGuids;
    public IReadOnlyList<Guid> GetEnemyGenerateGuids() => EnemyGenerateGuids is null ? Array.Empty<Guid>() : EnemyGenerateGuids;
