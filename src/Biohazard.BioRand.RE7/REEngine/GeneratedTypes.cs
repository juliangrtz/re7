...
namespace app {
    public class EnemySpawnInfo {
        ...
        public System.Collections.Generic.List<app.EnemySpawnInfo.RespawnConditionUnit>
            RespawnConditions { get; set; } = [];
...
namespace app {
    ...
    public class CH9PlayerEquipManager : EquipManager {
        public Enums.app.CH9PlayerEquipManager.WwiseSwitchListForEquipGauntlet wwiseSwitchListForEquipGauntlet {
            get;
            set;
        }
