...
internal static class RandomizerConfigurationDefinition {
    ...
    public static IntelOrca.Biohazard.BioRand.RandomizerConfigurationDefinition Create() {
        ...
        group.Items.Add(new GroupItem(){
            ...
            Description =
                "Whether to add a BioRand touch to the main menu such as a modified logo and \"New Game\" text.",
            Type = "switch",
            Default = true
        });
        ...
        group.Items.Add(new GroupItem(){
            ...
            Description =
                "Let BioRand include the unlockable weapons (Albert-01R, Infinite Ammo, Essence/Secrets of Defence etc.) in the pool.",
            Type = "switch",
            Default = false
        });
        ...
        group.Items.Add(new GroupItem(){
            ...
            Label = "Extra Enemies",
            Description =
                "The percentage of configured extra enemy spawns to randomly select and add (includes peaceful areas and boss arenas).",
            Type = "percent",
            Min = 0,
            Max = 1,
            Step = 0.01,
        ...
        group.Warning =
            "Random enemy speed must be enabled and pass the speed probability roll for these values to take effect.";
        ...
        group.Items.Add(new GroupItem(){
            ...
            Label = "Random Items",
            Description =
                "Whether to randomize most of the static items. Excludes certain items such as key items or the model shotguns.",
            Type = "switch",
            Default = true
        });
        ...
        group.Items.Add(new GroupItem(){
            ...
            Description =
                "Whether to randomize drugs (stabilizers and steroids) and coins in bird cages. Appropriate replacements are guaranteed.",
            Type = "switch",
            Default = false
        });
        ...
        group.Items.Add(new GroupItem(){
            ...
            Description =
                "Will also spawn explosive fake crates similar to the ones in Ethan Must Die and End of Zoe. " +
        ...
        group.Items.Add(new GroupItem(){
            ...
            Description =
                "Controls the size of your starting inventory as Ethan. The default is 12. Requires RE Framework.",
            Type = "dropdown",
        ...
        group.Items.Add(new GroupItem(){
            ...
            Description =
                "Controls the size of your starting inventory as Mia. The default is 12. Requires RE Framework.",
            Type = "dropdown",
            Options = ["random", "12", "16", "20"],
            Default = "12"
        });
